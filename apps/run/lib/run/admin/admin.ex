defmodule Run.Admin do
  ...
  def get_posts_by_page_id_and_identifier(blog_id, identifier) do
    query = from p in Post, where: p.blog_id == ^blog_id and p.identifier == ^identifier
